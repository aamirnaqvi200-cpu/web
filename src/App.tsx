...
const testimonialBadges: TestimonialBadge[] = [
  ...
  { word: "MASTERFUL", rating: 5, attribution: "— Design Week", position: { top: "15%", left: "75%" }, delay: 1.8 },
  { word: "BRILLIANT", rating: 5, attribution: "— Creative Review", position: { top: "25%", left: "20%" }, delay: 2.4 },
  { word: "INNOVATIVE", rating: 5, attribution: "— Fast Company", position: { top: "30%", left: "82%" }, delay: 3.0 },
  ...
  { word: "CAPTIVATING", rating: 5, attribution: "— Elle", position: { top: "45%", left: "63%" }, delay: 3.9 },
    { word: "CREATIVE", rating: 5, attribution: "— Inkwellmedia", position: { top: "55%", left: "73%" }, delay: 3.9 }
];
