...
/>
        ...
        <div 
          ref={textRef}
          className="absolute bottom-0 left-[200px] top-[200px] transform -translate-x-1/2 pointer-events-none transition-transform duration-100 ease-out"
          style={{ bottom: '5%' }}
        >
          <div 
            className="text-[4rem] md:text-[12rem] lg:text-[12rem] font-bold text-black/30 select-none leading-none opacity-0 animate-fade-in-delayed"
            style={{ 
              animationDelay: '0.1s', 
              animationFillMode: 'forwards' 
            }}
